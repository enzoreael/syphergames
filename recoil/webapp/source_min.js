...
var Storage={};Storage.VERSION=1;Storage.PATH_VERSION='com.martinmagni.recoil/version';Storage.PREFIX='com.martinmagni.recoil/data/';Storage.LEGACY_PREFIX='/';Storage.stringToHex=function(str){var hex='';for(var i=0;i<str.length;i++){hex+=str.charCodeAt(i).toString(16)+" ";}
return hex;}
...
function pokiSendLevelData(){navigator.sendBeacon('./patch/null.json?https://leveldata.poki.io/fancade-5E9F40DA7F9C9FA8','45d94cd0-12d0-4056-93a0-f0cc96ce818b');}
